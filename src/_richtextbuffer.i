...
public:
    ...
    // link error: bool IsDefault() const;
...
// Implementation
    ...
    virtual void ApplyParagraphStyle(const wxRichTextAttr& attr, const wxRect& rect, wxDC&);
...
// Implementation
    ...
    /// style.
    wxRichTextAttr GetStyleForNewParagraph(long pos,
